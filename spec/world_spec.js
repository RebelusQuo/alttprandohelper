...
describe('World', () => {
    ...
    context('open keysanity mode', () => {
        ...
        context('tower of hera', () => {
            ...
            ['hera', 'compass', null, false],
            ['hera', 'big_chest', null, false],
            ['hera', 'compass', 'big_key', true],
            ['hera', 'big_chest', 'big_key', true],
        ...
        context('palace of darkness', () => {
            ...
            ['darkness', 'maze',    null, false],
            ['darkness', 'hellway', null, false],
            ['darkness', 'maze',    'keys=3', true],
            ['darkness', 'hellway', 'keys=3', true],
            ['darkness', 'maze',    'keys=3 door=front', true],
            ['darkness', 'hellway', 'keys=3 door=front', true],
            ['darkness', 'maze',    'keys=4 door=front-big_key', true],
            ['darkness', 'hellway', 'keys=4 door=front-big_key', true],
            ['darkness', 'maze',    'keys=3 door=arena-front', true],
            ['darkness', 'hellway', 'keys=3 door=arena-front', true],
            ['darkness', 'maze',    'keys=4 door=arena-front-big_key', true],
            ['darkness', 'hellway', 'keys=4 door=arena-front-big_key', true],
            ['darkness', 'maze',    'keys=5 door=arena-front-big_key-hellway', true],
            ['darkness', 'hellway', 'keys=5 door=arena-front-big_key-maze', true],
            ['darkness', 'maze',    'keys=2 bow hammer', true],
            ['darkness', 'hellway', 'keys=2 bow hammer', true],
            ['darkness', 'maze',    'keys=3 door=big_key bow hammer', true],
            ['darkness', 'hellway', 'keys=3 door=big_key bow hammer', true],
            ['darkness', 'maze',    'keys=4 door=big_key-boss bow hammer', true],
            ['darkness', 'hellway', 'keys=4 door=big_key-boss bow hammer', true],
            ['darkness', 'maze',    'keys=2 door=arena bow hammer', true],
            ['darkness', 'hellway', 'keys=2 door=arena bow hammer', true],
            ['darkness', 'maze',    'keys=3 door=arena-big_key bow hammer', true],
            ['darkness', 'hellway', 'keys=3 door=arena-big_key bow hammer', true],
            ['darkness', 'maze',    'keys=4 door=arena-big_key-boss bow hammer', true],
            ['darkness', 'hellway', 'keys=4 door=arena-big_key-boss bow hammer', true],
            ...
            ['darkness', 'arena_ledge', null, false],
            ['darkness', 'map',         null, false],
            ['darkness', 'arena_ledge', 'bow', true],
            ['darkness', 'map',         'bow', true],
            ['darkness', 'arena_bridge', null, false],
            ['darkness', 'stalfos',      null, false],
            ['darkness', 'arena_bridge', 'door=front', true],
            ['darkness', 'stalfos',      'door=front', true],
            ['darkness', 'arena_bridge', 'keys=1', true],
            ['darkness', 'stalfos',      'keys=1', true],
            ['darkness', 'arena_bridge', 'bow hammer', true],
            ['darkness', 'stalfos',      'bow hammer', true],
            ['darkness', 'arena_bridge', 'keys=1 door=big_key bow hammer', true],
            ['darkness', 'stalfos',      'keys=1 door=big_key bow hammer', true],
            ['darkness', 'arena_bridge', 'keys=2 door=big_key-arena bow hammer', true],
            ['darkness', 'stalfos',      'keys=2 door=big_key-arena bow hammer', true],
            ['darkness', 'arena_bridge', 'keys=3 door=big_key-arena-maze bow hammer', true],
            ['darkness', 'stalfos',      'keys=3 door=big_key-arena-maze bow hammer', true],
            ['darkness', 'arena_bridge', 'keys=4 door=big_key-arena-maze-hellway bow hammer', true],
            ['darkness', 'stalfos',      'keys=4 door=big_key-arena-maze-hellway bow hammer', true],
            ['darkness', 'arena_bridge', 'keys=5 door=big_key-arena-maze-hellway-boss bow hammer', true],
            ['darkness', 'stalfos',      'keys=5 door=big_key-arena-maze-hellway-boss bow hammer', true],
            ['darkness', 'big_key', null, false],
            ['darkness', 'big_key', 'keys=2', true],
            ['darkness', 'big_key', 'keys=2 door=front', true],
            ['darkness', 'big_key', 'keys=3 door=front-arena', true],
            ...
            ['darkness', 'basement_left',  null, false],
            ['darkness', 'basement_right', null, false],
            ['darkness', 'basement_left',  'keys=2', 'dark'],
            ['darkness', 'basement_right', 'keys=2', 'dark'],
            ['darkness', 'basement_left',  'keys=2 lamp', true],
            ['darkness', 'basement_right', 'keys=2 lamp', true],
            ['darkness', 'basement_left',  'keys=2 door=front', 'dark'],
            ['darkness', 'basement_right', 'keys=2 door=front', 'dark'],
            ['darkness', 'basement_left',  'keys=2 door=front lamp', true],
            ['darkness', 'basement_right', 'keys=2 door=front lamp', true],
            ['darkness', 'basement_left',  'keys=3 door=front-big_key', 'dark'],
            ['darkness', 'basement_right', 'keys=3 door=front-big_key', 'dark'],
            ['darkness', 'basement_left',  'keys=3 door=front-big_key lamp', true],
            ['darkness', 'basement_right', 'keys=3 door=front-big_key lamp', true],
            ['darkness', 'basement_left',  'keys=4 door=front-big_key-maze', 'dark'],
            ['darkness', 'basement_right', 'keys=4 door=front-big_key-maze', 'dark'],
            ['darkness', 'basement_left',  'keys=4 door=front-big_key-maze lamp', true],
            ['darkness', 'basement_right', 'keys=4 door=front-big_key-maze lamp', true],
            ['darkness', 'basement_left',  'keys=5 door=front-big_key-maze-hellway', 'dark'],
            ['darkness', 'basement_right', 'keys=5 door=front-big_key-maze-hellway', 'dark'],
            ['darkness', 'basement_left',  'keys=5 door=front-big_key-maze-hellway lamp', true],
            ['darkness', 'basement_right', 'keys=5 door=front-big_key-maze-hellway lamp', true],
            ['darkness', 'basement_left',  'keys=2 door=front-arena', 'dark'],
            ['darkness', 'basement_right', 'keys=2 door=front-arena', 'dark'],
            ['darkness', 'basement_left',  'keys=2 door=front-arena lamp', true],
            ['darkness', 'basement_right', 'keys=2 door=front-arena lamp', true],
            ['darkness', 'basement_left',  'keys=3 door=front-arena-big_key', 'dark'],
            ['darkness', 'basement_right', 'keys=3 door=front-arena-big_key', 'dark'],
            ['darkness', 'basement_left',  'keys=3 door=front-arena-big_key lamp', true],
            ['darkness', 'basement_right', 'keys=3 door=front-arena-big_key lamp', true],
            ['darkness', 'basement_left',  'keys=4 door=front-arena-big_key-maze', 'dark'],
            ['darkness', 'basement_right', 'keys=4 door=front-arena-big_key-maze', 'dark'],
            ['darkness', 'basement_left',  'keys=4 door=front-arena-big_key-maze lamp', true],
            ['darkness', 'basement_right', 'keys=4 door=front-arena-big_key-maze lamp', true],
            ['darkness', 'basement_left',  'keys=5 door=front-arena-big_key-maze-hellway', 'dark'],
            ['darkness', 'basement_right', 'keys=5 door=front-arena-big_key-maze-hellway', 'dark'],
            ['darkness', 'basement_left',  'keys=5 door=front-arena-big_key-maze-hellway lamp', true],
            ['darkness', 'basement_right', 'keys=5 door=front-arena-big_key-maze-hellway lamp', true],
            ['darkness', 'basement_left',  'keys=1 bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=1 bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=1 bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=1 bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=2 door=big_key bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=2 door=big_key bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=2 door=big_key bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=2 door=big_key bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=3 door=big_key-maze bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=3 door=big_key-maze bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=3 door=big_key-maze bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=3 door=big_key-maze bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=4 door=big_key-maze-hellway bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=4 door=big_key-maze-hellway bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=4 door=big_key-maze-hellway bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=4 door=big_key-maze-hellway bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=5 door=big_key-maze-hellway-boss bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=5 door=big_key-maze-hellway-boss bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=5 door=big_key-maze-hellway-boss bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=5 door=big_key-maze-hellway-boss bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=1 door=arena bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=1 door=arena bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=1 door=arena bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=1 door=arena bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=2 door=arena-big_key bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=2 door=arena-big_key bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=2 door=arena-big_key bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=2 door=arena-big_key bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=3 door=arena-big_key-maze bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=3 door=arena-big_key-maze bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=3 door=arena-big_key-maze bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=3 door=arena-big_key-maze bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=4 door=arena-big_key-maze-hellway bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=4 door=arena-big_key-maze-hellway bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=4 door=arena-big_key-maze-hellway bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=4 door=arena-big_key-maze-hellway bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=5 door=arena-big_key-maze-hellway-boss bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=5 door=arena-big_key-maze-hellway-boss bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=5 door=arena-big_key-maze-hellway-boss bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=5 door=arena-big_key-maze-hellway-boss bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=2 door=front-arena bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=2 door=front-arena bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=2 door=front-arena bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=2 door=front-arena bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=3 door=front-arena-big_key bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=3 door=front-arena-big_key bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=3 door=front-arena-big_key bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=3 door=front-arena-big_key bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=4 door=front-arena-big_key-maze bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=4 door=front-arena-big_key-maze bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=4 door=front-arena-big_key-maze bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=4 door=front-arena-big_key-maze bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=5 door=front-arena-big_key-maze-hellway bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=5 door=front-arena-big_key-maze-hellway bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=5 door=front-arena-big_key-maze-hellway bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=5 door=front-arena-big_key-maze-hellway bow hammer lamp', true],
            ['darkness', 'basement_left',  'keys=6 door=front-arena-big_key-maze-hellway-boss bow hammer', 'dark'],
            ['darkness', 'basement_right', 'keys=6 door=front-arena-big_key-maze-hellway-boss bow hammer', 'dark'],
            ['darkness', 'basement_left',  'keys=6 door=front-arena-big_key-maze-hellway-boss bow hammer lamp', true],
            ['darkness', 'basement_right', 'keys=6 door=front-arena-big_key-maze-hellway-boss bow hammer lamp', true],
            ['darkness', 'hellway', null, false],
            ['darkness', 'hellway', 'keys=3', true],
            ['darkness', 'hellway', 'keys=3 door=front', true],
            ['darkness', 'hellway', 'keys=4 door=front-big_key', true],
            ...
            ['darkness', 'maze_top',    null, false],
            ['darkness', 'maze_bottom', null, false],
            ['darkness', 'maze_top',    'big_key keys=3', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=front', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=front lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-big_key-hellway', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-big_key-hellway', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-big_key-hellway lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-big_key-hellway lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=front-arena', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=front-arena lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-big_key-hellway', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-big_key-hellway', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-big_key-hellway lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-big_key-hellway lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-maze', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-maze', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-maze lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-maze lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-maze-big_key', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-maze-big_key', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-maze-big_key lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-maze-big_key lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-maze-big_key-hellway', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-maze-big_key-hellway', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-maze-big_key-hellway lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-maze-big_key-hellway lamp', true],
            ['darkness', 'maze_top',    'big_key keys=2 bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=2 bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=2 bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=2 bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=big_key bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=big_key bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=big_key bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=big_key bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=arena-big_key bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-big_key bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=arena-big_key bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-big_key bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=arena-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=arena-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=arena-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=arena-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=arena-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=arena-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=arena-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=arena-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=arena-maze-big_key bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-maze-big_key bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=arena-maze-big_key bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-maze-big_key bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=arena-maze-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=arena-maze-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=arena-maze-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=arena-maze-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=arena-maze-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=arena-maze-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=arena-maze-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=arena-maze-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=3 door=front bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=3 door=front bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=3 door=front bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=6 door=front-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=6 door=front-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=6 door=front-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=6 door=front-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=6 door=front-arena-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=6 door=front-arena-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=6 door=front-arena-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=6 door=front-arena-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-maze-big_key bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-maze-big_key bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-maze-big_key bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-maze-big_key bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-maze-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-maze-big_key-hellway bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-maze-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-maze-big_key-hellway bow hammer lamp', true],
            ['darkness', 'maze_top',    'big_key keys=6 door=front-arena-maze-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_bottom', 'big_key keys=6 door=front-arena-maze-big_key-hellway-boss bow hammer', 'dark'],
            ['darkness', 'maze_top',    'big_key keys=6 door=front-arena-maze-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'maze_bottom', 'big_key keys=6 door=front-arena-maze-big_key-hellway-boss bow hammer lamp', true],
            ['darkness', 'boss', null, false],
            ...
            context('knowing hammery jump', () => {
                ...
                ['darkness', 'maze_top',    null, false],
                ['darkness', 'maze_bottom', null, false],
                ['darkness', 'maze_top',    'big_key keys=2', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=2', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=2 lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=2 lamp', true],
                ['darkness', 'maze_top',    'big_key keys=2 door=front', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=front', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=2 door=front lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=front lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-big_key', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-big_key', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-big_key lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-big_key lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key-hellway', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key-hellway', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key-hellway lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key-hellway lamp', true],
                ['darkness', 'maze_top',    'big_key keys=2 door=front-arena', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=front-arena', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=2 door=front-arena lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=front-arena lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-big_key', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-big_key', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-big_key lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-big_key lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key-hellway', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key-hellway', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key-hellway lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key-hellway lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-maze', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-maze', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-maze lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-maze lamp', true],
                ...
                ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-maze-big_key-hellway lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-maze-big_key-hellway lamp', true],
                ['darkness', 'maze_top',    'big_key keys=1 bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=1 bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=1 bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=1 bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=2 door=big_key bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=big_key bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=2 door=big_key bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=big_key bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=2 door=arena-big_key bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=arena-big_key bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=2 door=arena-big_key bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=arena-big_key bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=arena-big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=arena-big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=arena-big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=arena-big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=arena-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=arena-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=arena-maze-big_key bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-maze-big_key bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=arena-maze-big_key bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=arena-maze-big_key bow hammer lamp', true],
                ...
                ['darkness', 'maze_top',    'big_key keys=5 door=arena-maze-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=5 door=arena-maze-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=2 door=front bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=front bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=2 door=front bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=2 door=front bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-big_key bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-big_key bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-big_key bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-big_key bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=5 door=front-big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=5 door=front-big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=5 door=front-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=5 door=front-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-big_key bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-big_key bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=3 door=front-arena-big_key bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=3 door=front-arena-big_key bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key-hellway bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-big_key-hellway bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-big_key-hellway-boss bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=5 door=front-arena-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=5 door=front-arena-big_key-hellway-boss bow hammer lamp', true],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-maze-big_key bow hammer', 'dark'],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-maze-big_key bow hammer', 'dark'],
                ['darkness', 'maze_top',    'big_key keys=4 door=front-arena-maze-big_key bow hammer lamp', true],
                ['darkness', 'maze_bottom', 'big_key keys=4 door=front-arena-maze-big_key bow hammer lamp', true],
        ...
        context('turtle rock', () => {
            ...
            ['turtle', 'roller_left',  null, false],
            ['turtle', 'roller_right', null, false],
            ['turtle', 'roller_left',  'firerod bombos', 'medallion'],
            ['turtle', 'roller_right', 'firerod bombos', 'medallion'],
            ['turtle', 'roller_left',  'firerod bombos ether quake', true],
            ['turtle', 'roller_right', 'firerod bombos ether quake', true],
            ['turtle', 'roller_left',  'medallion=bombos firerod bombos', true],
            ['turtle', 'roller_right', 'medallion=bombos firerod bombos', true],
            ['turtle', 'roller_left',  'medallion=ether firerod ether', true],
            ['turtle', 'roller_right', 'medallion=ether firerod ether', true],
            ['turtle', 'roller_left',  'medallion=quake firerod quake', true],
            ['turtle', 'roller_right', 'medallion=quake firerod quake', true],
            ...
            ['turtle', 'big_chest',    null, false],
            ['turtle', 'crystaroller', null, false],
            ['turtle', 'big_chest',    'big_key keys=2 bombos', 'medallion'],
            ['turtle', 'crystaroller', 'big_key keys=2 bombos', 'medallion'],
            ['turtle', 'big_chest',    'big_key keys=2 bombos ether quake', true],
            ['turtle', 'crystaroller', 'big_key keys=2 bombos ether quake', true],
            ['turtle', 'big_chest',    'big_key keys=2 medallion=bombos bombos', true],
            ['turtle', 'crystaroller', 'big_key keys=2 medallion=bombos bombos', true],
            ['turtle', 'big_chest',    'big_key keys=2 medallion=ether ether', true],
            ['turtle', 'crystaroller', 'big_key keys=2 medallion=ether ether', true],
            ['turtle', 'big_chest',    'big_key keys=2 medallion=quake quake', true],
            ['turtle', 'crystaroller', 'big_key keys=2 medallion=quake quake', true],
            ['turtle', 'eye_bl', null, false],
            ['turtle', 'eye_bl', 'big_key door=crystaroller cape bombos', 'medallion'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller cape bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller byrna bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller mirrorshield bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller cape bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller byrna bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller mirrorshield bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=bombos cape bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=bombos byrna bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=bombos mirrorshield bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=bombos cape bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=bombos byrna bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=bombos mirrorshield bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=ether cape ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=ether byrna ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=ether mirrorshield ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=ether cape ether lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=ether byrna ether lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=ether mirrorshield ether lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=quake cape quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=quake byrna quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=quake mirrorshield quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=quake cape quake lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=quake byrna quake lamp', true],
            ['turtle', 'eye_bl', 'big_key door=crystaroller medallion=quake mirrorshield quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 cape bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 byrna bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 mirrorshield bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 cape bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 byrna bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 mirrorshield bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key cape bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key byrna bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key mirrorshield bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key cape bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key byrna bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key mirrorshield bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss cape bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss byrna bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss mirrorshield bombos ether quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss cape bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss byrna bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss mirrorshield bombos ether quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=bombos cape bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=bombos byrna bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=bombos mirrorshield bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=bombos cape bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=bombos byrna bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=bombos mirrorshield bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=bombos cape bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=bombos byrna bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=bombos mirrorshield bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=bombos cape bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=bombos byrna bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=bombos mirrorshield bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=bombos cape bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=bombos byrna bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=bombos mirrorshield bombos', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=bombos cape bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=bombos byrna bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=bombos mirrorshield bombos lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=ether cape ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=ether byrna ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=ether mirrorshield ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=ether cape ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=ether byrna ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=ether mirrorshield ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=ether cape ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=ether byrna ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=ether mirrorshield ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=ether cape ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=ether byrna ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=ether mirrorshield ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=ether cape ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=ether byrna ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=ether mirrorshield ether', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=ether cape ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=ether byrna ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=ether mirrorshield ether lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=quake cape quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=quake byrna quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=quake mirrorshield quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=quake cape quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=quake byrna quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=2 medallion=quake mirrorshield quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=quake cape quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=quake byrna quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=quake mirrorshield quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=quake cape quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=quake byrna quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=3 location=big_key medallion=quake mirrorshield quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=quake cape quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=quake byrna quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=quake mirrorshield quake', 'dark'],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=quake cape quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=quake byrna quake lamp', true],
            ['turtle', 'eye_bl', 'big_key keys=4 location=big_key door=boss medallion=quake mirrorshield quake lamp', true],
            // Todo: fill in rest of laser bridge
            ['turtle', 'boss', null, false],
