(function (window) {
    window.dungeon_layouts = function () {
        return {
            eastern: {
            ...
            darkness: {
                first: [['map', 'compass', 'arena_ledge', 'arena_bridge', 'basement_left', 'basement_right', 'hellway', 'big_chest', 'maze_top', 'maze_bottom', 'boss'], ['arena', 'hellway', 'maze', 'boss']],
